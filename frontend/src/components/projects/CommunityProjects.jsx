...
const CommunityProjects = () => {
  ...
  const resources = [
    {
    title: "Thomas Career Development Association",
      description:
    ...
    {
    title: "PROS - Professional Roadmap to Ongoing Success",
      description:
    ...
    {
    title: "FSU Seminole Success Stories",
      description:
